        ...
        <div class="container" style="margin-top: 2rem;">
            <div class="row ">
                <div class="container_destaque">
                    <div style="margin-bottom: 13px;font-size: 24px; font-weight: 700;">DESTAQUES</div>
                ...
                <div class="container_importante" >
                    <div class="form-group">
                        <div style="margin-bottom: 13px;font-size: 24px; font-weight: 700;">EM ALTA</div>
                    </div>
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="container_videos">
                    <div style="margin-bottom: 13px;font-size: 24px; font-weight: 700; margin-left: 10px;">Laboratórios de Tecnologia</div>
                    <div class="row">
                        <div class="col-md-12" style="margin-bottom: 10px;">
